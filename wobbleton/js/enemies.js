// ============================================================
//  ENEMY FACTORY (WOBBLETON) — the regular Neon City rock golems
//  (no googly eyes), with Wobbleton stat tuning per type
...
const EnemyFactory_TYPES = {
    grunt:   { scale: 1.05, hp: 36,  speed: 2.3, dmg: 9,  col: '#ffd23f', range: 0,  fly: 0, points: 10,  glow: 0xc24bff },
    runner:  { scale: 0.8,  hp: 18,  speed: 4.4, dmg: 6,  col: '#ff5ca2', range: 0,  fly: 0, points: 12,  glow: 0xff3bd0 },
    tank:    { scale: 1.7,  hp: 130, speed: 1.3, dmg: 22, col: '#43c6ff', range: 0,  fly: 0, points: 30,  glow: 0xa24bff },
    shooter: { scale: 1.05, hp: 30,  speed: 1.6, dmg: 14, col: '#b06cf6', range: 26, fly: 0, points: 22,  glow: 0x8a5bff },
    dragon:  { scale: 1.5,  hp: 110, speed: 3.0, dmg: 16, col: '#ff8a3d', range: 30, fly: 1, points: 40,  glow: 0xff5a1e },
    boss:    { scale: 2.6,  hp: 420, speed: 1.5, dmg: 30, col: '#ff5a5a', range: 22, fly: 0, points: 120, glow: 0xff2d95 },
    spider:  { scale: 2.4,  hp: 600, speed: 2.2, dmg: 34, col: '#5fe3a1', range: 0,  fly: 0, points: 200, glow: 0x8bff36 },
    sapling: { scale: 0.7,  hp: 14,  speed: 3.8, dmg: 6,  col: '#9be84a', range: 0,  fly: 0, points: 10,  glow: 0x9be84a },
    bramble: { scale: 1.0,  hp: 48,  speed: 2.2, dmg: 12, col: '#c6f23a', range: 0,  fly: 0, points: 18,  glow: 0xc6f23a },
    treant:  { scale: 1.6,  hp: 95,  speed: 1.2, dmg: 14, col: '#6fd83a', range: 24, fly: 0, points: 35,  glow: 0x6fd83a },
...
const EnemyFactory = {
  ...
  build(type, skin) {
    ...
    if (g.userData.parts && g.userData.parts.wings) g.userData.wing = g.userData.parts.wings;
    this._skin = 'rock';
    return g;
  },
